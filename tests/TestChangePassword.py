...
class TestChangePassword(unittest.TestCase):
    ...
    @patch('Controllers.ChangePassword.ChangePassword.check_login_exist_on_switch')
    @patch('sys.exit')
    @patch('Controllers.ControllerMain.ControllerMain.get_current_password')
    ...
    @patch('Controllers.ControllerMain.ControllerMain.network_send_data')
    @patch('Controllers.ControllerMain.ControllerMain.network_receive_data_until')
    def test_dlink_change_password_authorisation_unsuccess(self, mock_receive_data_until, mock_send_data,
                                                           mock_authorisation,
    ...
    @patch('Controllers.ControllerMain.ControllerMain.network_send_data')
    @patch('Controllers.ControllerMain.ControllerMain.network_receive_data_until')
    def test_dlink_change_password_login_exist_unsuccess(self, mock_receive_data_until, mock_send_data,
                                                         mock_authorisation,
                                                         mock_close_connection, mock_get_dlink_model,
                                                         mock_get_current_password,
                                                         mock_sys_exit, mock_check_login_exist_on_switch):
